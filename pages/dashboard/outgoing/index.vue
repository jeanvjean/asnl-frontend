            ...
            >
              <template #action="slotProps">
                <router-link
                  ...
                  :to="`/dashboard/outgoing/${slotProps.rowObject._id}`"
                  class="px-6 py-1 rounded-sm text-sm text-btn-purple text-sm  border border-btn-purple"
                >
                  View Details
                </router-link>
...
import { fetchOcns } from '@/module/Incoming'
        ...
        .then((response) => {
          tableBody.value = response.docs.map((icn: any) => {
            ...
            return {
              ...
              cylinders: icn.cylinders.length,
              date: new Date(icn.date).toDateString(),
              _id: icn._id,
            }
          })
