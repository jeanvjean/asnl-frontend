<template>
  <div class="py-6 px-6">
        ...
        <template #action="slotProps"
          ><button
            class="
              ...
              rounded-sm
            "
            @click=";(singleRoute = slotProps.rowObject), (showRoute = true)"
          >
            Details
          </button></template
        >
    ...
    <single-route
      v-if="showRoute"
      :route-plan="singleRoute"
      @close="showRoute = false"
      @refresh="fetchRoutePlans(pageNumber, pageLimit)"
    />
