  ...
  <div :key="componentKey" class="py-6 px-6">
    <div class="flex justify-between items-center px-6">
      ...
      <div v-if="user.role === 'admin'">
        <router-link
          to="/dashboard/vehicles/create-vehicle"
          class="
            flex
            space-x-2
            items-center
          ...
          >
            ...
            <router-link
              class="
                ...
                overflow-none
              "
              :to="'/dashboard/vehicles/update-vehicle/' + slotProps.rowId"
            >
              Update Vehicle
            </router-link>
            <button
              ...
              "
              @click="
                ;(selectedVehicle = slotProps.rowId), (showFinalDelete = true)
              "
            >
              Delete Vehicle
            </button>
            <router-link
              :to="
                '/dashboard/vehicles/corrective-maintenance/' + slotProps.rowId
              "
              class="
                block
                px-3
    ...
    <assign-driver
      ...
      :drivers="drivers"
      :current-driver="selectedVehicle"
    ...
    <final-delete
      ...
      @deleted="deleteVehicle(selectedVehicle)"
    />
  </div>
</template>
