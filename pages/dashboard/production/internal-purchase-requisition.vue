  ...
  <div>
    <div class="py-4 px-2">
      ...
      <div class="w-3/4 grid grid-rows-1 lg:grid-cols-3 my-10 px-8">
        <div class="space-y-4">
          <p class="uppercase text-base tracking-tight">IPO NOS</p>
          <p class="text-base">PRO 1313</p>
        </div>
        <div class="space-y-4">
        ...
        <div class="space-y-4">
          <p class="uppercase text-base tracking-tight">Internal Supplier</p>
          <p class="text-base">ASNL JOS</p>
        </div>
      </div>
