<template>
  <back-drop>
    ...
    >
      <div class="my-2">
        <div class="space-y-2">
          <p class="text-lg font-semibold">Send to Production</p>
          <p class="text-gray-500 text-sm">
            Select number of Cylinders and priority
          </p>
        </div>
        <svg
          class="
      ...
      <div class="space-y-2 text-sm">
        <select-component
          :label-title="'Oxygen 10kg'"
          :default-option-text="'Select Number of Cylinders'"
          :select-array="[]"
        />
        <select-component
          :label-title="'Priority'"
          :default-option-text="'Select Priority'"
          :select-array="[]"
        />
